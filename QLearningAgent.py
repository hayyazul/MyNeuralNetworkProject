...
class QAgent:
    ...
    def __init__(self, neural_network_layers, learning_rate=0.01, alpha=0.7, discount=0.9):
        """
        """
        self.neural_network = NN.NeuralNetwork(neural_network_layers, learning_rate)
        self.alpha = alpha
...
if __name__ == "__main__":
    ...
    # Very inefficient training loop that teaches the NN to 'count'.
